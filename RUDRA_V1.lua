...
---------------- CONFIG ----------------
local SPAM_LINE_LEN = 140
local WARNING_LINE_LEN = 150
...
---------------- TMKX WORDS (EDIT HERE IF YOU WANT) ----------------
local TMKX_WORDS = {
...
local targetBox  = box("TARGET NAME", 0.12)
local delayBox   = box("DELAY (seconds)", 0.28)
local patternBox = box("PATTERN (-_- , ___ , @@@)", 0.44)
...
warn("RUDRA V1 | FINAL UNIVERSAL | LOADED")
